...
%Citing a book: \citep{therails7way}

%Citing a website: \citep{rails-guides}

%Citing an article: \citep{mittelbach2004latex}

%Citing a website: \citep{aws-rekognition}

%Citing a website: \citep{aws-s3-storage}


%Citing a website: \citep{rest-arch}

 
%Citing a website: \citep{reactjs-docs}

%Citing a website: \citep{nextjs-docs}

%Citing a website: \citep{material-ui-docs}


%Citing a website: \citep{heroku-docs}

%Citing a website: \citep{postgresql-docs}

%Citing a website: \citep{postman-docs}

%Citing a website: \citep{git-docs}

%Citing a website: \citep{git-workflows}

%Citing a specification: \citep{oauth-spec}

%Citing a website: \citep{sentry-docs}

% \citep{wiki-hci}
%Citing a book: \citep{bootstrap-reactjs}

%Citing a book: \citep{ecommerce-application}
...
\bibliographystyle{unsrtnat} % Use the "unsrtnat" BibTeX style for formatting the Bibliography / References
